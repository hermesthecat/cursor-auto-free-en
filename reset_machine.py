...
class MachineIDResetter:
    ...
    def reset_machine_ids(self):
        """Reset machine IDs and backup the original file"""
        try:
            ...
            if not os.access(self.db_path, os.R_OK | os.W_OK):
                ...
                print(
                    f"{Fore.RED}{EMOJI['ERROR']} If you have used go-cursor-help to modify the ID; please change the read-only permission of the file {self.db_path} {Style.RESET_ALL}"
                )
                return False
            ...
            print(
                f"{Fore.YELLOW}{EMOJI['INFO']} Please try running this program with administrator privileges{Style.RESET_ALL}"
            )
            return False
...
if __name__ == "__main__":
    ...
    print(f"{Fore.CYAN}{EMOJI['RESET']} Cursor Machine Identifier Reset Tool{Style.RESET_ALL}")
